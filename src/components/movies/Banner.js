  ...
  return (
    <>
      ...
      >
            ...
            <div className="flex justify-center sm:justify-start">
              {movie?.id ? (
                ...
                <>
                  <button
                    onClick={() => navigate(`/play/${movie?.id}`)}
                    className="animate-pulse bg-neutral-900 transition duration-500 ease-in-out shadow-2xl flex items-center mb-3 mr-3 text-base sm:text-xl font-semibold text-neutral-500 py-2 sm:py-2 px-10 sm:px-14 rounded-md"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        {showModal && (
          <>
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto  fixed  inset-0 top-[100px]   z-50 outline-none focus:outline-none">
              <div className="relative w-auto mt-24 sm:my-6 mx-4 max-w-3xl">
                ...
                <Fade bottom duration={500}>
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-neutral-800 outline-none focus:outline-none">
                    ...
                    <div className="flex ml-4 items-center -mt-14  relative  z-[999999]">
                      <button
                        ...
                        onClick={() => {
                          // console.log(urlId);
                          navigate(`/play/${moviePopupInfo?.id}}`);
                        }}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div
                        className="group top-[5%]  p-1 ml-2 mt-2 backdrop-blur-[20px] bg-transparent border-2 border-white hover:bg-white hover:text-black fixed right-4 rounded-full cursor-pointer float-right font-semibold outline-none focus:outline-none ease-linear transition-all duration-150"
